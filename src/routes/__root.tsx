...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ravindra — Builder, Learner, Dreamer" },
      { name: "description", content: "A personal note from Ravindra to the She & Soul team — built with care." },
      { property: "og:title", content: "Ravindra — Builder, Learner, Dreamer" },
      { property: "og:description", content: "A personal note from Ravindra to the She & Soul team — built with care." },
